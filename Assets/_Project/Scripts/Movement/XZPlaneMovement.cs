...
namespace MobaGameplay.Movement
{
    public class XZPlaneMovement : BaseMovement
    {
        ...
        [Tooltip("Velocidad normal de caminar.")]
        [SerializeField] private float walkSpeed = 3f;
        [Tooltip("Velocidad rápida (correr/sprint).")]
        ...
        // Devuelve la velocidad actual real según el estado
        ...
        private void HandlePathingMovement()
        {
            ...
            currentVelocity = CurrentSpeed; // Para el animator
